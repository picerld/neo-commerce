...
// maplibre-gl v6 dropped its default export in favor of pure named exports
// (this generated file was written against an older API shape) — a
// namespace import keeps every `MapLibreGL.X` reference below working
