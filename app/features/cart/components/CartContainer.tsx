          ...
          return (
            <Card key={item.id} className="p-4">
              <CardContent className="flex flex-wrap items-center gap-3 px-0">
                <Link href={`/products/${item.productSlug}`} className="relative flex size-20 shrink-0 items-center justify-center overflow-hidden rounded-xl border-2 border-border/60 bg-muted">
